    ...
    <v-container style="background-color: #e8faff;">
        ...
        <v-form ref="transactionForm" @submit.prevent="submitForm" v-model="isFormValid">
            ...
            <div v-else class="image-section mb-4">
                <div v-for="product in filteredProducts" :key="product.product_id" @click="selectProduct(product)"
                    class="image-section-item">
                    <div class="product-card" :class="{ active: selectedCard === product.product_id }">
                        ...
                        <svg class="mb-1" height="90px" width="90px" version="1.1" id="_x32_"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            viewBox="0 0 512 512" xml:space="preserve" fill="#01c7fc">
                    ...
                    <v-container class="overflow-auto pb-10" style="height: 700px;">
                                ...
                                <div v-for="selectedProduct in this.selectedProducts" :key="selectedProduct.id">
                                    <div class="selected-products-card">
                                        <div class="d-flex flex-start">
                                            <svg height="71px" width="71px" version="1.1" id="_x32_"
                                                xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512"
                                                xml:space="preserve" fill="#01c7fc">
                                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        ...
                        <div class="mb-7 ga-2 d-flex justify-center">
                            ...
                            <div @click="customerPwd" :class="{ 'selected': this.customer_type_id === 2 }"
                                ...
                                <p style="font-size: 12px;" class="text-center">w/ Special <br />needs</p>
                            </div>
            ...
            <v-bottom-sheet v-model="placeOrderSheet">
                <v-card class="pa-2" style="background-color: #e8faff; border-radius: 60px 60px 0 0;">
                    <v-container class="overflow-auto pb-10" style="height: 700px;">
                                ...
                                <div v-for="selectedProduct in this.selectedProducts" :key="selectedProduct.id">
                                    <div class="selected-products-card">
                                        <div class="d-flex flex-column w-100 px-1">
                                            ...
                                            <div class="d-flex align-center justify-space-between">
                                                <p><strong>₱{{ selectedProduct.base_price }}</strong></p>
                                                <p><strong>x{{ selectedProduct.quantity }}</strong></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <!-- Add in disabled: If cash > total amount -->
                        <!-- Add in disabled: If total amount <= 0 -->
...
export default {
        ...
        selectedProducts: {
            handler() {
                if (this.order_type_charge && Number(this.order_type_charge) !== 0) {
                    this.subTotal += Number(this.order_type_charge);
                } else {
    ...
    methods: {
        ...
        async generateQRPhCode() {
            ...
            // if (this.subTotal = 0 || this.totalQuantity = 0) {
