            ...
            <div v-else class="image-section">
                <div v-for="product in filteredProducts" :key="product.id" @click="selectProduct(product)"
                    ...
                    <div class="product-card">
                        ...
                        <svg height="142px" width="142px" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve" fill="#008cb4" stroke="#008cb4">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <style type="text/css"> .st0{fill:#008cb4;} </style>
                                <g>
