            ...
            <div v-else class="image-section mb-4">
                <div v-for="product in filteredProducts" :key="product.id" @click="selectProduct(product)"
                    ...
                    <div class="product-card">
                        ...
                        <svg height="90px" width="90px" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve" fill="#01c7fc">
